...
print("Aware local time is {}, time zone is {}".format(aware_local_time, aware_local_time.tzinfo))
print("Aware UTC time is {}, time zone is {}".format(aware_utc_time, aware_utc_time.tzinfo))

gap_time = datetime.datetime(2020, 11, 22, 19, 8, 0, 0)
print(gap_time)
